...
GBL_EXPORT GblOptionGroup* GblCmdParser_optionGroup(const GblCmdParser* pSelf, size_t  index) {
...
GBL_EXPORT const GblCmdArg* GblCmdParser_positionalArg(const GblCmdParser* pSelf, size_t  index) {
