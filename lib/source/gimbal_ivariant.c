...
GBL_API GblIVariantIFace_valuesFromVa(const GblIVariantIFace* pSelf, const char* pFmt, va_list argList, GblUint* pCount, GblVariant pVariant[]) {
    GBL_API_BEGIN(NULL);
    GBL_API_VERIFY_POINTER(pSelf);
    ...
    *pCount = 0;
    ...
    while((curChar = pFmt[*pCount]) != '\0') {
        ...
        switch(curChar) {
        case 'q': pCurVariant->type = GBL_TYPE_INT64;   pCurVariant->i64        = va_arg(argList, int64_t);  break;
        case 'l': pCurVariant->type = GBL_TYPE_UINT32;  pCurVariant->u32        = va_arg(argList, uint32_t); break;
        case 'i': pCurVariant->type = GBL_TYPE_INT32;   pCurVariant->i32        = va_arg(argList, int32_t);  break;
        case 'd': pCurVariant->type = GBL_TYPE_DOUBLE;  pCurVariant->f64        = va_arg(argList, double);   break;
        case 'p': pCurVariant->type = GBL_TYPE_POINTER; pCurVariant->pVoid      = va_arg(argList, void*);    break;
 ...
 * 3) shit pants
 */
GBL_API GblIVariantIFace_constructValueCopy(const GblIVariantIFace* pSelf, GblVariant* pVariant, va_list args) {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
        GBL_API_CALL(GblIVariantIFace_valuesFromVa(pSelf, pSelf->pSetValueFmt, args, &count, pVariants));
 ...
 * 5) Shit pants
 */
GBL_API GblIVariantIFace_constructValueMove(const GblIVariantIFace* pSelf, GblVariant* pVariant, va_list args) {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
...
GBL_API GblIVariantIFace_setValueCopy(const GblIVariantIFace* pSelf, GblVariant* pVariant, va_list args) GBL_NOEXCEPT {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
...
GBL_API GblIVariantIFace_setValueMove(const GblIVariantIFace* pSelf, GblVariant* pVariant, va_list args) GBL_NOEXCEPT {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
...
GBL_API GblIVariantIFace_getValueCopy(const GblIVariantIFace* pSelf, const GblVariant* pVariant, va_list args) GBL_NOEXCEPT {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
        GBL_API_CALL(GblIVariantIFace_valuesFromVa(pSelf, pSelf->pGetValueFmt, args, &count, pVariants));
        if(pSelf->supportedOps & GBL_IVARIANT_OP_FLAG_GET_VALUE_COPY) {
            GBL_API_VERIFY_POINTER(pSelf->pFnGet);
...
GBL_API GblIVariantIFace_getValuePeek(const GblIVariantIFace* pSelf, const GblVariant* pVariant, va_list args) GBL_NOEXCEPT {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
...
GBL_API GblIVariantIFace_getValueTake(const GblIVariantIFace* pSelf, const GblVariant* pVariant, va_list args) GBL_NOEXCEPT {
    GBL_API_BEGIN(NULL); {
        GBL_API_VERIFY_POINTER(pSelf);
        GblUint count = 0;
        GblVariant* pVariants = GBL_ALLOCA(sizeof(GblVariant)*GBL_IVARIANT_VALUE_VAR_ARG_MAX);
