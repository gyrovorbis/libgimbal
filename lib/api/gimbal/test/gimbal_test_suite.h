...
#define GBL_TEST_SUITE(inst)               (GBL_INSTANCE_CAST(inst, GBL_TEST_SUITE_TYPE, GblTestSuite))
#define GBL_TEST_SUITE_CLASS(klass)        (GBL_CLASS_CAST(klass, GBL_TEST_SUITE_TYPE, GblTestSuiteClass))
#define GBL_TEST_SUITE_GET_CLASS(inst)     (GBL_INSTANCE_GET_CLASS(inst, GBL_TEST_SUITE_TYPE, GblTestSuiteClass))
