...
///@details Function-style cast operator to cast the given derived struct to the GblInstance base
#define GBL_INSTANCE(instance)              ((GblInstance*)instance)
///@details Returns the GblClass* corresponding to a given GblInstance*
