...
#define GBL_TYPE_BUILTIN_COUNT                  24
...
#define GBL_TYPE_INSTANCE_CAST(instance, toType, cType)         \
                                            ((cType*)gblTypeInstanceCast((GblInstance*)instance, toType))
#define GBL_TYPE_INSTANCE_IS_A(instance, toType)                \
                                            (gblTypeInstanceIsA((GblInstance*)instance, toType))
#define GBL_TYPE_CLASS_CAST(klass, toType, cType)               \
                                            ((cType*)gblTypeClassCast((GblClass*)klass, toType))
#define GBL_TYPE_CLASS_IS_A(klass, toType)                      \
                                            (gblTypeClassIsA((GblClass*)klass, toType))
#define GBL_TYPE_INSTANCE_CLASS_CAST(instance, toType, cType)   \
...
#define GBL_INTERFACE(klass)                GBL_TYPE_CLASS_CAST(klass, GBL_TYPE_INTERFACE, GblInterface)
...
GBL_EXPORT GBL_RESULT           gblTypeReinit(GblContext hCtx)                                          GBL_NOEXCEPT;
...
GBL_EXPORT GblClass*            gblTypeClassRef(GblType typeId)                                         GBL_NOEXCEPT;
...
GBL_EXPORT GblBool              gblTypeClassIsA(const GblClass* pClass, GblType toType)                 GBL_NOEXCEPT;
...
GBL_EXPORT GblBool              gblTypeInstanceIsA(const GblInstance* pInstance, GblType toType)        GBL_NOEXCEPT;
