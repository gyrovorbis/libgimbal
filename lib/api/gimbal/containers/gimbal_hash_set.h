...
typedef GblHash       (*GblHashSetHashFn)(CSELF, const void*);
typedef GblBool       (*GblHashSetCmpFn) (CSELF, const void*, const void*);
typedef void          (*GblHashSetDtorFn)(CSELF, void*);
typedef GblBool       (*GblHashSetIterFn)(CSELF, void*, void*);
 ...
 *
 *  \note
 *  Performance is pretty darn good. Read speed is faster than both C++'s std::unordered_map and
...
GBL_EXPORT GblHashSetIter    GblHashSet_find          (CSELF, const void* pKey)         GBL_NOEXCEPT;
