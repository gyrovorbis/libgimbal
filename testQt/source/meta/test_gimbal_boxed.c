...
GBL_API GblBoxed_test_register(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(GBL_BOXED_TYPE_CHECK(boxedType_));
    GBL_API_END();
}
...
GBL_API GblBoxed_test_variant(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(GblVariant_type(&v) == boxedType_);
    ...
    GBL_TEST_COMPARE(refCountBegin, GblType_classRefCount(boxedType_));
    GBL_API_END();
}
...
GBL_API GblBoxed_test_conversions(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(GblVariant_canConvert(boxedType_, GBL_POINTER_TYPE));
    ...
    GBL_TEST_VERIFY(GblVariant_canConvert(GBL_POINTER_TYPE, boxedType_));

    GBL_TEST_VERIFY(GblVariant_canConvert(boxedType_, GBL_STRING_TYPE));
...
GBL_API GblBoxed_test_final(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblType_classRefCount(boxedType_), 0);
    GBL_API_END();
}
