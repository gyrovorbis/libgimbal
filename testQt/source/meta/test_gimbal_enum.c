...
GBL_API GblEnum_test_register(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(enumType_ != GBL_INVALID_TYPE);
    GBL_TEST_VERIFY(GBL_ENUM_TYPE_CHECK(enumType_));

    pEnumClass_ = (GblEnumClass*)GblClass_ref(enumType_);
    GBL_TEST_VERIFY(pEnumClass_);
    GBL_API_END();
}

GBL_API GblEnum_test_class_name(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblEnumClass_nameFromIndex(pEnumClass_,
                                                  1),
                       "GREEN"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblEnumClass_nameQuarkFromIndex(pEnumClass_,
                                                                         0)),
                       "RED"),
                0);
    GBL_TEST_COMPARE(strcmp(GblEnumClass_nameFromValue(pEnumClass_,
                                                  BLUE),
                       "BLUE"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblEnumClass_nameQuarkFromValue(pEnumClass_,
                                                                         GREEN)),
                       "GREEN"),
                0);
    GBL_API_END();
...
GBL_API GblEnum_test_class_nick(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblEnumClass_nickFromIndex(pEnumClass_,
                                                  1),
                       "Green"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblEnumClass_nickQuarkFromIndex(pEnumClass_,
                                                                         0)),
                       "Red"),
                0);
    GBL_TEST_COMPARE(strcmp(GblEnumClass_nickFromValue(pEnumClass_,
                                                  BLUE),
                       "Blue"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblEnumClass_nickQuarkFromValue(pEnumClass_,
                                                                         GREEN)),
                       "Green"),
                0);
    GBL_API_END();
...
GBL_API GblEnum_test_class_value(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblEnumClass_valueFromIndex(pEnumClass_, 1), GREEN);
    GBL_TEST_COMPARE(GblEnumClass_valueFromName(pEnumClass_, "BLUE"), BLUE);
    GBL_TEST_COMPARE(GblEnumClass_valueFromNameQuark(pEnumClass_, GblQuark_fromString("RED")), RED);
    GBL_TEST_COMPARE(GblEnumClass_valueFromNick(pEnumClass_, "Green"), GREEN);
    GBL_TEST_COMPARE(GblEnumClass_valueFromNickQuark(pEnumClass_, GblQuark_fromString("Red")), RED);
    GBL_TEST_VERIFY(GblEnumClass_valueCheck(pEnumClass_, BLUE));
    GBL_TEST_VERIFY(!GblEnumClass_valueCheck(pEnumClass_, 9999));
    GBL_API_END();
}

GBL_API GblEnum_test_value_from(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblEnum_fromName("RED", enumType_), RED);
    GBL_TEST_COMPARE(GblEnum_fromNameQuark(GblQuark_fromString("GREEN"), enumType_), GREEN);
    GBL_TEST_COMPARE(GblEnum_fromNick("Blue", enumType_), BLUE);
    GBL_TEST_COMPARE(GblEnum_fromNickQuark(GblQuark_fromString("Green"), enumType_), GREEN);
    GBL_API_END();
}

GBL_API GblEnum_test_value_to(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblEnum_name(RED, enumType_), "RED"), 0);
    GBL_TEST_COMPARE(GblEnum_nameQuark(GREEN, enumType_), GblQuark_fromString("GREEN"));
    GBL_TEST_COMPARE(strcmp(GblEnum_nick(BLUE, enumType_), "Blue"), 0);
    GBL_TEST_COMPARE(GblEnum_nickQuark(BLUE, enumType_), GblQuark_fromString("Blue"));
    GBL_API_END();
}

GBL_API GblEnum_test_value_check(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(!GblEnum_check(99999, enumType_));
    GBL_TEST_VERIFY(GblEnum_check(BLUE, enumType_));
    GBL_API_END();
}
...
GBL_API GblEnum_test_variant(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(GblVariant_type(&v) == enumType_);
    ...
    GBL_TEST_COMPARE(refCountBegin, GblType_classRefCount(enumType_));
    GBL_API_END();
}
...
GBL_API GblEnum_test_variant_fail(GblContext* pCtx) {
    ...
    GblVariant v;
    GBL_TEST_COMPARE(GblVariant_constructValueCopy(&v, enumType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_constructValueMove(&v, enumType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_setValueMove(&v, enumType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_setValueCopy(&v, enumType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_END();
}
...
GBL_API GblEnum_test_final(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblClass_unref(GBL_CLASS(pEnumClass_)), 0);
    GBL_API_END();
}
