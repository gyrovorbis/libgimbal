...
GBL_API GblFlags_test_register(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(flagsType_ != GBL_INVALID_TYPE);
    GBL_TEST_VERIFY(GBL_FLAGS_TYPE_CHECK(flagsType_));

    pFlagsClass_ = (GblFlagsClass*)GblClass_ref(flagsType_);
    GBL_TEST_VERIFY(pFlagsClass_);
    GBL_API_END();
}

GBL_API GblFlags_test_class_name(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblFlagsClass_nameFromIndex(pFlagsClass_,
                                                  1),
                       "WRITE"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblFlagsClass_nameQuarkFromIndex(pFlagsClass_,
                                                                         0)),
                       "READ"),
                0);
    GBL_TEST_COMPARE(strcmp(GblFlagsClass_nameFromValue(pFlagsClass_,
                                                   LOAD),
                       "LOAD"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblFlagsClass_nameQuarkFromValue(pFlagsClass_,
                                                                          SAVE)),
                       "SAVE"),
                0);
    GBL_API_END();
...
GBL_API GblFlags_test_class_nick(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblFlagsClass_nickFromIndex(pFlagsClass_,
                                                  1),
                       "Write"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblFlagsClass_nickQuarkFromIndex(pFlagsClass_,
                                                                         3)),
                       "Save"),
                0);
    GBL_TEST_COMPARE(strcmp(GblFlagsClass_nickFromValue(pFlagsClass_,
                                                   READ),
                       "Read"),
                0);
    GBL_TEST_COMPARE(strcmp(GblQuark_toString(GblFlagsClass_nickQuarkFromValue(pFlagsClass_,
                                                                          LOAD)),
                       "Load"),
                0);
    GBL_API_END();
...
GBL_API GblFlags_test_class_value(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblFlagsClass_valueFromIndex(pFlagsClass_, 1), WRITE);
    GBL_TEST_COMPARE(GblFlagsClass_valueFromName(pFlagsClass_, "READ"), READ);
    GBL_TEST_COMPARE(GblFlagsClass_valueFromNameQuark(pFlagsClass_, GblQuark_fromString("SAVE")), SAVE);
    GBL_TEST_COMPARE(GblFlagsClass_valueFromNick(pFlagsClass_, "Load"), LOAD);
    GBL_TEST_COMPARE(GblFlagsClass_valueFromNickQuark(pFlagsClass_, GblQuark_fromString("Write")), WRITE);
    GBL_TEST_VERIFY(GblFlagsClass_valueCheck(pFlagsClass_, READ|WRITE|LOAD));
    GBL_TEST_VERIFY(!GblFlagsClass_valueCheck(pFlagsClass_, SAVE|9999));
    GBL_API_END();
}
...
GBL_API GblFlags_test_value_from(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblFlags_fromName("READ", flagsType_), READ);
    GBL_TEST_COMPARE(GblFlags_fromNameQuark(GblQuark_fromString("WRITE"), flagsType_), WRITE);
    GBL_TEST_COMPARE(GblFlags_fromNick("Load", flagsType_), LOAD);
    GBL_TEST_COMPARE(GblFlags_fromNickQuark(GblQuark_fromString("Save"), flagsType_), SAVE);
    GBL_API_END();
}

GBL_API GblFlags_test_value_to(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(strcmp(GblFlags_name(READ, flagsType_), "READ"), 0);
    GBL_TEST_COMPARE(GblFlags_nameQuark(WRITE, flagsType_), GblQuark_fromString("WRITE"));
    GBL_TEST_COMPARE(strcmp(GblFlags_nick(LOAD, flagsType_), "Load"), 0);
    GBL_TEST_COMPARE(GblFlags_nickQuark(SAVE, flagsType_), GblQuark_fromString("Save"));
    GBL_API_END();
}

GBL_API GblFlags_test_value_check(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(!GblFlags_check(WRITE|99999, flagsType_));
    GBL_TEST_VERIFY(GblFlags_check(SAVE, flagsType_));
    GBL_API_END();
}
...
GBL_API GblFlags_test_variant(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(GblVariant_type(&v) == flagsType_);
    ...
    GBL_TEST_COMPARE(refCountBegin, GblType_classRefCount(flagsType_));
...
GBL_API GblFlags_test_variant_fail(GblContext* pCtx) {
    ...
    GblVariant v;
    GBL_TEST_COMPARE(GblVariant_constructValueCopy(&v, flagsType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_constructValueMove(&v, flagsType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_setValueMove(&v, flagsType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_TEST_COMPARE(GblVariant_setValueCopy(&v, flagsType_, 9999),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_END();
}
...
GBL_API GblFlags_test_final(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblClass_unref(GBL_CLASS(pFlagsClass_)), 0);
    GBL_API_END();
}
