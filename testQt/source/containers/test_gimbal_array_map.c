...
GBL_API GblArrayMap_test_null_invalid(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblArrayMap_atValue(&pMap1_, 0), 0);
    GBL_TEST_COMPARE(GBL_API_LAST_RESULT(), GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_CLEAR_LAST_RECORD();

    GBL_TEST_COMPARE(GblArrayMap_atVariant(&pMap1_, 0), NULL);
    GBL_TEST_COMPARE(GBL_API_LAST_RESULT(), GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_CLEAR_LAST_RECORD();
...
GBL_API GblArrayMap_test_null(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 0);
    GBL_TEST_VERIFY(GblArrayMap_empty(&pMap1_));
    GBL_TEST_COMPARE(GblArrayMap_context(&pMap1_), NULL);
    GBL_TEST_VERIFY(!GblArrayMap_contains(&pMap1_, 0));
    GBL_TEST_VERIFY(!GblArrayMap_containsUserdata(&pMap1_, 0));
    GBL_TEST_VERIFY(!GblArrayMap_containsVariant(&pMap1_, 0));
    GBL_TEST_COMPARE(GblArrayMap_getValue(&pMap1_, 0), 0);
    GBL_TEST_COMPARE(GblArrayMap_getVariant(&pMap1_, 0), NULL);
    GBL_TEST_VERIFY(!GblArrayMap_erase(&pMap1_, 0));
    GBL_TEST_VERIFY(!GblArrayMap_extractValue(&pMap1_, 0, &value));
    GBL_TEST_VERIFY(!GblArrayMap_extractVariant(&pMap1_, 0, &variant));
    GBL_TEST_COMPARE(GblArrayMap_find(&pMap1_, 0), GBL_ARRAY_MAP_NPOS);
    GBL_TEST_COMPARE(GblArrayMap_probeKey(&pMap1_, 0), 0);
    GBL_TEST_COMPARE(GblArrayMap_probeValue(&pMap1_, 0), 0);
    GBL_TEST_COMPARE(GblArrayMap_probeVariant(&pMap1_, 0), NULL);
...
GBL_API GblArrayMap_test_empty(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(pMap1_);
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 0);
    GBL_TEST_VERIFY(GblArrayMap_empty(&pMap1_));
    GBL_TEST_COMPARE(GblArrayMap_context(&pMap1_), pCtx);
    GBL_TEST_VERIFY(!GblArrayMap_contains(&pMap1_, 0));
    GBL_TEST_VERIFY(!GblArrayMap_containsUserdata(&pMap1_, 0));
    GBL_TEST_VERIFY(!GblArrayMap_containsVariant(&pMap1_, 0));
    GBL_TEST_COMPARE(GblArrayMap_getValue(&pMap1_, 0), 0);
...
GBL_API GblArrayMap_test_setUserdata(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 1);
    GBL_TEST_VERIFY(!GblArrayMap_empty(&pMap1_));
    GBL_TEST_VERIFY(GblArrayMap_contains(&pMap1_, (uintptr_t)"key1"));
    GBL_TEST_VERIFY(GblArrayMap_containsUserdata(&pMap1_, (uintptr_t)"key1"));
    GBL_TEST_VERIFY(!GblArrayMap_containsVariant(&pMap1_, (uintptr_t)"key1"));
    GBL_TEST_COMPARE(GblArrayMap_getValue(&pMap1_, (uintptr_t)"key1"), 1);
    GBL_TEST_COMPARE(GblArrayMap_getVariant(&pMap1_, (uintptr_t)"key1"), NULL);
    GBL_TEST_COMPARE(GblArrayMap_atValue(&pMap1_, (uintptr_t)"key1"), 1);
    GBL_TEST_COMPARE(GblArrayMap_atVariant(&pMap1_, (uintptr_t)"key1"), NULL);
    GBL_TEST_COMPARE(GblArrayMap_find(&pMap1_, (uintptr_t)"key1"), 0);
    const char* pKey = (const char*)GblArrayMap_probeKey(&pMap1_, 0);
    GBL_TEST_COMPARE(strcmp(pKey, "key1"), 0);
    GBL_TEST_COMPARE(GblArrayMap_probeValue(&pMap1_, 0), 1);
    GBL_TEST_COMPARE(GblArrayMap_probeVariant(&pMap1_, 0), NULL);
    GBL_API_END();
}
...
GBL_API GblArrayMap_test_setUserdata_lazy(GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayMap_setUserdata(&pMap2_,
                                                ...
                                                (uintptr_t)2,
                                                GblArrayMap_destructor_));
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap2_), 1);
    GBL_TEST_VERIFY(!GblArrayMap_empty(&pMap2_));
    GBL_TEST_VERIFY(GblArrayMap_contains(&pMap2_, (uintptr_t)GblQuark_fromString("key2")));
    GBL_TEST_VERIFY(GblArrayMap_containsUserdata(&pMap2_, (uintptr_t)GblQuark_fromString("key2")));
    GBL_TEST_VERIFY(!GblArrayMap_containsVariant(&pMap2_, (uintptr_t)GblQuark_fromString("key2")));
    GBL_TEST_COMPARE(GblArrayMap_getValue(&pMap2_, (uintptr_t)GblQuark_fromString("key2")), 2);
    GBL_TEST_COMPARE(GblArrayMap_getVariant(&pMap2_, (uintptr_t)GblQuark_fromString("key2")), NULL);
    GBL_TEST_COMPARE(GblArrayMap_atValue(&pMap2_, (uintptr_t)GblQuark_fromString("key2")), 2);
    GBL_TEST_COMPARE(GblArrayMap_atVariant(&pMap2_, (uintptr_t)GblQuark_fromString("key2")), NULL);
    GBL_TEST_COMPARE(GblArrayMap_find(&pMap2_, (uintptr_t)GblQuark_fromString("key2")), 0);
    const char* pKey = (const char*)GblArrayMap_probeKey(&pMap2_, 0);
    GBL_TEST_COMPARE(strcmp(pKey, "key2"), 0);
    GBL_TEST_COMPARE(GblArrayMap_probeValue(&pMap2_, 0), 2);
    GBL_TEST_COMPARE(GblArrayMap_probeVariant(&pMap2_, 0), NULL);
    GBL_API_END();
}

GBL_API GblArrayMap_test_insertUserdata_duplicate(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblArrayMap_insertUserdata(&pMap1_, (uintptr_t)"key1", 5, NULL), 0);
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 1);
    GBL_API_END();
}
...
GBL_API GblArrayMap_test_validate_userdata_(GblContext* pCtx, GblArrayMap* pMap, uintptr_t key, uintptr_t value) {
    ...
    GBL_TEST_COMPARE(GblArrayMap_probeValue(&pMap1_, loc), value);
    GBL_API_END();
}
...
GBL_API GblArrayMap_test_validate_variant_(GblContext* pCtx, GblArrayMap* pMap, uintptr_t key, uintptr_t value) {
    ...
    GBL_TEST_COMPARE(strcmp(pKey, (const char*)key), 0);
    GBL_TEST_COMPARE(GblArrayMap_probeValue(&pMap1_, loc), value);
    GBL_TEST_COMPARE(GblArrayMap_probeVariant(&pMap1_, loc), pVariant);
    GBL_API_END();
}

GBL_API GblArrayMap_test_insertUserdata(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblArrayMap_insertUserdata(&pMap1_, (uintptr_t)"key3", 3, GblArrayMap_destructor_), 1);
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 2);
...
GBL_API GblArrayMap_test_insertVariant(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblArrayMap_insertVariant(&pMap1_, (uintptr_t)"key4", &variant), 2);
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 3);
    GBL_API_VERIFY_CALL(GblArrayMap_test_validate_variant_(pCtx,
                                                           pMap1_,
                                                           (uintptr_t)"key4",
                                                           0xdeadbeef));
...
GBL_API GblArrayMap_test_eraseUserdata(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(GblArrayMap_erase(&pMap1_, (uintptr_t)"key1"));
    GBL_TEST_COMPARE(GblArrayMap_size(&pMap1_), 2);
    GBL_TEST_COMPARE(GblArrayMap_find(&pMap1_, (uintptr_t)"key1"), GBL_ARRAY_MAP_NPOS);
