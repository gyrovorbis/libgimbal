#include "containers/test_gimbal_linked_list.h"
...
GBL_API GblLinkedList_test_init(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(GblLinkedList_empty(&list1_));
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 0);
    GBL_TEST_COMPARE(GblLinkedList_front(&list1_), NULL);
    GBL_TEST_COMPARE(GblLinkedList_back(&list1_), NULL);
    GBL_API_END();
}
...
GBL_API verifyListNode_(GblContext* pCtx, GblLinkedListNode* pList, GblLinkedListNode* pNode, GblSize expectedIndex, const char* pString) {
    ...
    TestStruct_* pTest = GBL_LINKED_LIST_ENTRY(pNode,
                                               TestStruct_,
                                               listNode);
    GBL_TEST_VERIFY(strcmp(pTest->pString, pString) == 0);
...
GBL_API GblLinkedList_test_pushBack(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(!GblLinkedList_empty(&list1_));
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 1);
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 2);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_front(&list1_),
                                        0,
...
GBL_API GblLinkedList_test_pushFront(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 3);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_front(&list1_),
                                        0,
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 3);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list2_,
...
GBL_API GblLinkedList_test_remove(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(!GblLinkedList_remove(&list2_, &testStructs_[0].listNode));
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 3);
    GBL_TEST_VERIFY(GblLinkedList_remove(&list2_, &testStructs_[3].listNode));
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 2);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list2_,
                                        GblLinkedList_front(&list2_),
                                        0,
...
GBL_API GblLinkedList_test_moveBack(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 4);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_back(&list1_),
                                        3,
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 5);
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 1);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_back(&list1_),
                                        4,
...
GBL_API GblLinkedList_test_moveFront(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 6);
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 0);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_front(&list1_),
                                        0,
...
GBL_API GblLinkedList_test_joinBack(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblLinkedList_count(&list2_), 6);
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 0);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list2_,
                                        GblLinkedList_front(&list2_),
...
GBL_API GblLinkedList_test_erase(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(!GblLinkedList_erase(&list2_, 1));
    GBL_TEST_VERIFY(GblLinkedList_erase(&list1_, 1));
    GBL_TEST_COMPARE(GblLinkedList_count(&list1_), 5);
    GBL_API_VERIFY_CALL(verifyListNode_(pCtx,
                                        &list1_,
                                        GblLinkedList_at(&list1_, 1),
