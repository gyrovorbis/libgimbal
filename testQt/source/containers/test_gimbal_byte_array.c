...
GBL_API GblByteArray_test_copy(GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblByteArray_verify_(pCtx,
                                             ...
                                             "lol",
                                             1));
    GBL_TEST_VERIFY(GblByteArray_compare(pByteArray1_, pByteArray2_) == 0);
    GBL_TEST_VERIFY(GblByteArray_equals(pByteArray1_, pByteArray2_));
...
GBL_API GblByteArray_test_unref(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_COMPARE(GblByteArray_unref(pByteArray1_), 1);
    GBL_API_VERIFY_CALL(GblByteArray_verify_(pCtx,
                                             pByteArray1_,
                                             "lol",
                                             1));
    ...
    GBL_TEST_COMPARE(GblByteArray_unref(pByteArray2_), 0);
...
GBL_API GblByteArray_test_write_read_invalid(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblByteArray_write(pByteArray1_, 12, 33, "lolol"),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_CLEAR_LAST_RECORD();

    GBL_TEST_COMPARE(GblByteArray_read(pByteArray1_, 12, 33, NULL),
                GBL_RESULT_ERROR_OUT_OF_RANGE);
    GBL_API_CLEAR_LAST_RECORD();

    GBL_TEST_COMPARE(GblByteArray_at(pByteArray1_, GblByteArray_size(pByteArray1_)+1),
                0);
    GBL_API_CLEAR_LAST_RECORD();
...
GBL_API GblByteArray_test_acquire_release(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(strcmp(pBuffer, "Megaman") == 0);
...
GBL_API GblByteArray_test_resize(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblByteArray_size(pByteArray1_), 10);
    for(unsigned i = 0; i < 10; ++i) {
        GBL_TEST_COMPARE(GblByteArray_at(pByteArray1_, i), 0);
        GBL_API_VERIFY_LAST_RECORD();
    }
...
GBL_API GblByteArray_test_shrink(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblByteArray_size(pByteArray1_), 4);

    GBL_TEST_COMPARE(strcmp(GblByteArray_cString(pByteArray1_),
                                            "XY"), 0);
    GBL_API_END();
}
...
GBL_API GblByteArray_test_final(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_API_CLEAR_LAST_RECORD();
    GBL_TEST_COMPARE(GblByteArray_unref(pByteArray1_), 0);
    GBL_TEST_COMPARE(refActiveCount_,  GblRef_activeCount());
    GBL_API_END();
}
