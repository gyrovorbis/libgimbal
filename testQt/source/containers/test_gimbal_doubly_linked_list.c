...
GBL_API GblDoublyLinkedList_test_init(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(GblDoublyLinkedList_empty(&list1_));
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 0);
    GBL_TEST_COMPARE(GblDoublyLinkedList_front(&list1_), NULL);
    GBL_TEST_COMPARE(GblDoublyLinkedList_back(&list1_), NULL);
    GBL_API_END();
}
...
GBL_API GblDoublyLinkedList_test_pushBack(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(!GblDoublyLinkedList_empty(&list1_));
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 1);
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 2);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_front(&list1_),
                                        0,
...
GBL_API GblDoublyLinkedList_test_pushFront(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 3);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_front(&list1_),
                                        0,
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 3);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list2_,
...
GBL_API GblDoublyLinkedList_test_remove(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    //GBL_TEST_VERIFY(!GblDoublyLinkedList_remove(&list2_, &testStructs_[0].listNode));
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 3);
    GblDoublyLinkedList_remove(&list2_, &testStructs_[3].listNode);
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 2);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list2_,
                                        GblDoublyLinkedList_front(&list2_),
                                        0,
...
GBL_API GblDoublyLinkedList_test_moveBack(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 4);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_back(&list1_),
                                        3,
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 5);
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 1);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_back(&list1_),
                                        4,
...
GBL_API GblDoublyLinkedList_test_moveFront(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 6);
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 0);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_front(&list1_),
                                        0,
...
GBL_API GblDoublyLinkedList_test_joinBack(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list2_), 6);
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 0);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list2_,
                                        GblDoublyLinkedList_front(&list2_),
...
GBL_API GblDoublyLinkedList_test_erase(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_VERIFY(!GblDoublyLinkedList_erase(&list2_, 1));
    GBL_TEST_VERIFY(GblDoublyLinkedList_erase(&list1_, 1));
    GBL_TEST_COMPARE(GblDoublyLinkedList_count(&list1_), 5);
    GBL_API_VERIFY_CALL(verifyDListNode_(pCtx,
                                        &list1_,
                                        GblDoublyLinkedList_at(&list1_, 1),
