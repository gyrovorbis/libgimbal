...
GBL_API GblQuark_test_fromStringStatic(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(staticString_ != GBL_QUARK_INVALID);
    GBL_TEST_COMPARE(GblQuark_count(), 1);
    GBL_TEST_COMPARE(GblQuark_bytesUsed(), 0);
...
GBL_API GblQuark_test_fromString(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(string_ != GBL_QUARK_INVALID);
    GBL_TEST_COMPARE(GblQuark_count(), 2);
    GBL_TEST_COMPARE(GblQuark_bytesUsed(), 7);
...
GBL_API GblQuark_test_fromStringSized(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(string_ != GBL_QUARK_INVALID);
    GBL_TEST_COMPARE(GblQuark_count(), 3);
    GBL_TEST_COMPARE(GblQuark_bytesUsed(), 19);
...
GBL_API GblQuark_test_tryString(GblContext* pCtx) {
    ...
    GBL_TEST_COMPARE(quark, staticString_);

    quark = GblQuark_tryString("String");
    GBL_TEST_COMPARE(quark, string_);

    quark = GblQuark_tryString("SizedString");
    GBL_TEST_COMPARE(quark, sizedString_);
...
GBL_API GblQuark_test_extraPage(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(pagedString_ != GBL_QUARK_INVALID);
    GBL_TEST_COMPARE(GblQuark_tryString("PagedString"), pagedString_);
    GBL_TEST_COMPARE(GblQuark_bytesUsed(), oldBytesUsed + pageFreeBytes + 1 + 12);
    GBL_TEST_COMPARE(GblQuark_count(), 5);
...
GBL_API GblQuark_test_toString(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(staticString_), "StaticString") == 0);
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(string_),       "String")       == 0);
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(sizedString_),  "SizedString")  == 0);
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(pagedString_),  "PagedString")  == 0);
    GBL_API_END();
}
...
GBL_API GblQuark_test_internString(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(strcmp(GblQuark_internString("InternString"),
                      "InternString") == 0);
    const GblQuark tryQuark = GblQuark_tryString("InternString");
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(tryQuark), "InternString") == 0);
    GBL_TEST_COMPARE(GblQuark_count(), 6);
    GBL_API_END();
}
...
GBL_API GblQuark_test_internStringSized(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(strcmp(GblQuark_internStringSized("InternStringSizedabc", 15),
                      "InternStringSiz") == 0);
    const GblQuark tryQuark = GblQuark_tryString("InternStringSiz");
    GBL_TEST_VERIFY(strcmp(GblQuark_toString(tryQuark), "InternStringSiz") == 0);
    GBL_TEST_COMPARE(GblQuark_count(), 7);
    GBL_API_END();
}
...
GBL_API GblQuark_test_internStringStatic(GblContext* pCtx) {
    ...
    GBL_TEST_VERIFY(strcmp(GblQuark_internStringStatic("InternStatic"),
                      "InternStatic") == 0);
    GBL_TEST_COMPARE(GblQuark_count(), 8);
    GBL_API_END();
}
