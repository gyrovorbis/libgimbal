...
{   \
    false, GBL_CONFIG_LOG_PARTIAL_ENABLED, GBL_CONFIG_LOG_ERROR_ENABLED, GBL_CONFIG_LOG_UNKNOWN_ENABLED \
}

#define GBL_CONFIG_OPTIONS_RECORD_ENABLED_DECL()  \
{ \
    false, GBL_CONFIG_LAST_CALL_RECORD_PARTIAL_ENABLED, GBL_CONFIG_LAST_CALL_RECORD_ERROR_ENABLED, GBL_CONFIG_LAST_CALL_RECORD_UNKNOWN_ENABLED \
}

#define GBL_CONFIG_OPTIONS_LOG_LEVEL_DECL()  \
{ \
    GBL_LOG_LEVEL_VERBOSE, GBL_CONFIG_LOG_PARTIAL_LEVEL, GBL_CONFIG_LOG_ERROR_LEVEL, GBL_CONFIG_LOG_UNKNOWN_LEVEL \
}
