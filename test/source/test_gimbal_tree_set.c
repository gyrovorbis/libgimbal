#include "test_gimbal_tree_set.h"
...
GBL_API GblTreeSet_test_init(GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblTreeSet_construct(&treeSet1_,
                                             ...
                                             pCtx,
                                             (void*)0xdeadbeef));
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 0);
    GBL_VERIFY(GblTreeSet_empty(&treeSet1_));
    GBL_COMPARE(GblTreeSet_context(&treeSet1_), pCtx);
    GBL_COMPARE(GblTreeSet_userdata(&treeSet1_), (void*)0xdeadbeef);
    GBL_API_END();
}
...
GBL_API GblTreeSet_test_get_empty_invalid(GblContext* pCtx) {
    ...
    GBL_COMPARE(GblTreeSet_at(&treeSet1_, "lol"), NULL);
...
GBL_API GblTreeSet_test_get_empty(GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_COMPARE(GblTreeSet_get(&treeSet1_, "lol"), NULL);
    GBL_VERIFY(!GblTreeSet_contains(&treeSet1_, "lol"));
    GBL_COMPARE(GblTreeSet_count(&treeSet1_, "lol"), 0);
    GBL_API_END();
}
...
GBL_API GblTreeSet_verifyEntry_(GblContext* pCtx,
    ...
    GBL_VERIFY(pReturn);
    GBL_COMPARE(pReturn->value, pEntry->value);
    pReturn = GblTreeSet_atHint(pSet, pEntry, &hint_);
    GBL_API_VERIFY_LAST_RECORD();
    GBL_VERIFY(pReturn);
    GBL_COMPARE(pReturn->value, pEntry->value);
    GBL_VERIFY(GblTreeSet_contains(pSet, pEntry));
    GBL_COMPARE(GblTreeSet_count(pSet, pEntry), 1);
    GBL_API_END();
}
...
GBL_API GblTreeSet_test_set(GblContext* pCtx) {
    ...
    uint64_t hint = 0;
    GBL_COMPARE(GblTreeSet_setHint(&treeSet1_, &entry, &hint), NULL);
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 1);
...
GBL_API GblTreeSet_test_set_hint(GblContext* pCtx) {
    ...
    GBL_COMPARE(GblTreeSet_setHint(&treeSet1_, &entry, &hint_), NULL);
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 2);
    GBL_API_VERIFY_CALL(GblTreeSet_verifyEntry_(pCtx,
                                                &treeSet1_,
                                                &entry));
    entry.pKey = "entry0";
    ...
    entry.value = 2;
    GBL_COMPARE(GblTreeSet_setHint(&treeSet1_, &entry, &hint_), NULL);
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 3);
    GBL_API_VERIFY_CALL(GblTreeSet_verifyEntry_(pCtx,
                                                &treeSet1_,
                                                &entry));
    GBL_API_END();
...
GBL_API GblTreeSet_test_extract(GblContext* pCtx) {
    ...
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 2);
    GBL_COMPARE(dtorCount_, 0);
    GBL_COMPARE(lastDtorValue_, 0);
    GBL_VERIFY(pEntry);
    GBL_COMPARE(strcmp(entry.pKey, pEntry->pKey), 0);
    GBL_COMPARE(entry.value, pEntry->value);
    GBL_API_END();
}
...
GBL_API GblTreeSet_test_erase(GblContext* pCtx) {
    ...
    GBL_VERIFY(GblTreeSet_erase(&treeSet1_, &entry));
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 1);
    GBL_COMPARE(dtorCount_, 1);
    GBL_COMPARE(lastDtorValue_, 2);
    entry.pKey = "entry0";
    entry.value = 1;
    GBL_API_VERIFY_CALL(GblTreeSet_verifyEntry_(pCtx,
                                                &treeSet1_,
...
GBL_API GblTreeSet_test_clear(GblContext* pCtx) {
    ...
    GBL_VERIFY(GblTreeSet_empty(&treeSet1_));
    GBL_COMPARE(GblTreeSet_size(&treeSet1_), 0);
    GBL_COMPARE(dtorCount_, 2);
    GBL_COMPARE(lastDtorValue_, 1);
    GBL_API_END();
}
