...
static GBL_RESULT GblOpaqueTestSuite_register_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_TYPE(pSelf_->opaqueType, GBL_OPAQUE_TYPE);
    GBL_API_END();
}
...
static GBL_RESULT GblOpaqueTestSuite_variant_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructOpaqueMove(&v, pSelf_->opaqueType, (void*)GblStringRef_create("test")));
    GBL_API_VERIFY_CALL(GblVariant_constructCopy(&v2, &v));
    GBL_TEST_VERIFY(GblVariant_equals(&v, &v2));
    GBL_API_VERIFY_CALL(GblVariant_destruct(&v2));
    GBL_API_VERIFY_CALL(GblVariant_destruct(&v));
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructOpaqueCopy(&v, pSelf_->opaqueType, (void*)pValue));
    GBL_TEST_COMPARE(strcmp(GblVariant_getOpaquePeek(&v), "Hi"), 0); // Utility / Get Value
    GBL_API_VERIFY_CALL(GblVariant_destruct(&v));
    GblStringRef_release(pValue);

    // Value Move Constructor
    GBL_API_VERIFY_CALL(GblVariant_constructValueMove(&v, pSelf_->opaqueType, (void*)GblStringRef_create("Bye")));
    ...
    GBL_API_VERIFY_CALL(GblVariant_setOpaqueCopy(&v, pSelf_->opaqueType, (void*)pValue));
    GBL_TEST_COMPARE(strcmp(GblVariant_getOpaquePeek(&v), "Shy"), 0); // Utility / Get Value
    GblStringRef_release(pValue);

    // Value Set Move
    GBL_API_VERIFY_CALL(GblVariant_setValueMove(&v, pSelf_->opaqueType, (void*)GblStringRef_create("Fly")));
...
static GBL_RESULT GblOpaqueTestSuite_conversions_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructOpaqueMove(&v1, pSelf_->opaqueType, (void*)GblStringRef_create("Test")));
