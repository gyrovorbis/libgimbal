...
static GBL_RESULT GblEnumTestSuite_variant_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructEnum(&v, pSelf_->enumType, GREEN));
    GBL_TEST_COMPARE(GblVariant_getEnum(&v), GREEN); // Utility / Get Value
    GBL_API_VERIFY_CALL(GblVariant_destruct(&v));

    // Value Move Constructor
    GBL_API_VERIFY_CALL(GblVariant_constructValueMove(&v, pSelf_->enumType, BLUE));
    GBL_TEST_COMPARE(GblVariant_getEnum(&v), BLUE);

    // Utility / Value Set Copy
    GBL_API_VERIFY_CALL(GblVariant_setEnum(&v, pSelf_->enumType, RED));
    GBL_TEST_COMPARE(GblVariant_getEnum(&v), RED);

    // Value Set Move
    GBL_API_VERIFY_CALL(GblVariant_setValueMove(&v, pSelf_->enumType, GREEN));
...
static GBL_RESULT GblEnumTestSuite_variant_conversions_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructValueCopy(&variant, pSelf_->enumType, BLUE));
