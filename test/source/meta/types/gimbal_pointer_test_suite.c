...
static GBL_RESULT GblPointerTestSuite_variant_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    // Default constructor
    GBL_API_VERIFY_CALL(GblVariant_constructDefault(&v, pSelf_->pointerType));
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructPointer(&v, pSelf_->pointerType, "Hi"));
    GBL_TEST_COMPARE(strcmp(GblVariant_getPointer(&v), "Hi"), 0); // Utility / Get Value
    GBL_API_VERIFY_CALL(GblVariant_destruct(&v));

    // Value Move Constructor
    GBL_API_VERIFY_CALL(GblVariant_constructValueMove(&v, pSelf_->pointerType, "Bye"));
    GBL_TEST_COMPARE(strcmp(GblVariant_getPointer(&v), "Bye"), 0); // Utility / Get Value

    // Utility / Value Set Copy
    GBL_API_VERIFY_CALL(GblVariant_setPointer(&v, pSelf_->pointerType, "Shy"));
    GBL_TEST_COMPARE(strcmp(GblVariant_getPointer(&v), "Shy"), 0); // Utility / Get Value

    // Value Set Move
    GBL_API_VERIFY_CALL(GblVariant_setValueMove(&v, pSelf_->pointerType, "Fly"));
...
static GBL_RESULT GblPointerTestSuite_conversions_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblVariant_constructPointer(&v1, pSelf_->pointerType, "Test"));
