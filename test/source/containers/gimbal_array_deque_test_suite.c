...
static GBL_RESULT GblArrayDequeTestSuite_constructEmpty_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_construct(&pSelf_->deques[0],
                                                sizeof(const char*),
                                                0, 0, NULL, pCtx));

    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[0], NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_constructWithData_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_construct(&pSelf_->deques[1],
                                                sizeof(const char*),
                                                0, 1, &stringLiterals_[0], pCtx));

    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[1], "a", NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_copy_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_construct(&pSelf_->deques[3],
                                                9999,
                                                0, 0, NULL, pCtx));

    GBL_API_VERIFY_CALL(GblArrayDeque_copy(&pSelf_->deques[3], &pSelf_->deques[1]));

    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[3], "a", NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_move_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_construct(&pSelf_->deques[4],
                                                33,
                                                0, 0, NULL, pCtx));

    GBL_API_VERIFY_CALL(GblArrayDeque_move(&pSelf_->deques[4], &pSelf_->deques[3]));

    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[4], "a", NULL));
    ...
    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[3], NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_pushBackResize_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    for(GblSize i = 0; i < 10; ++i) {
        GBL_API_VERIFY_CALL(GblArrayDeque_pushBack(&pSelf_->deques[0], &stringLiterals_[10+i]));
    }

    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[0],
...
static GBL_RESULT GblArrayDequeTestSuite_emplaceBackResize_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_construct(&pSelf_->deques[2],
                                                sizeof(const char*),
                                                0, 0, NULL, pCtx));
    ...
    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[2],
                        "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_pushFront_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    for(GblSize i = 0; i < 6; ++i) {
        GBL_API_VERIFY_CALL(GblArrayDeque_pushFront(&pSelf_->deques[0], &stringLiterals_[9-i]));
    }
...
static GBL_RESULT GblArrayDequeTestSuite_pushFrontResize_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    for(GblSize i = 0; i < 4; ++i) {
        GBL_API_VERIFY_CALL(GblArrayDeque_pushFront(&pSelf_->deques[0], &stringLiterals_[3-i]));
    }
...
static GBL_RESULT GblArrayDequeTestSuite_resizeShrink_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_resize(&pSelf_->deques[0], 5));
...
static GBL_RESULT GblArrayDequeTestSuite_resizeGrow_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_resize(&pSelf_->deques[0], 10));
...
static GBL_RESULT GblArrayDequeTestSuite_reserveIgnored_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_reserve(&pSelf_->deques[0], 16));
...
static GBL_RESULT GblArrayDequeTestSuite_reserveGrow_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_reserve(&pSelf_->deques[0], 35));
...
static GBL_RESULT GblArrayDequeTestSuite_shrinkToFitShrink_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDeque_shrinkToFit(&pSelf_->deques[0]));
...
static GBL_RESULT GblArrayDequeTestSuite_insertBackEmpty_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblArrayDequeTestSuite_verify_(pCtx, &pSelf_->deques[3],
                        "a", "b", "c", NULL));
...
static GBL_RESULT GblArrayDequeTestSuite_destruct_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    for(GblSize i = 0; i < 5; ++i)
        GBL_API_VERIFY_CALL(GblArrayDeque_destruct(&pSelf_->deques[i]));
