...
static GBL_RESULT GblRingListTestSuite_createEmpty_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[0], NULL));
...
static GBL_RESULT GblRingListTestSuite_createSingle_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[1], "Xbox", NULL));
...
static GBL_RESULT GblRingListTestSuite_createMulti_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[2], "Dreamcast", "GameCube", NULL));
...
static GBL_RESULT GblRingListTestSuite_copyShallow_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[2], "Dreamcast", "GameCube", NULL));
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[3], "Dreamcast", "GameCube", NULL));
...
static void* deepCopyStr_(const void* pValue, void* pClosure) {
    ...
    char* pNewStr = NULL;
    GBL_API_BEGIN(NULL);
    pNewStr = GBL_API_MALLOC(totalLen);
...
static GBL_RESULT GblRingListTestSuite_copyDeep_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[4], "Dreamcaster", "GameCubeer", NULL));
...
static GBL_RESULT GblRingListTestSuite_pushBackSingle_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushBack(pSelf_->ringLists[1], "Playstation 2"));

    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[1], "Xbox", "Playstation 2", NULL));
...
static GBL_RESULT GblRingListTestSuite_pushBackMulti_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushBack(pSelf_->ringLists[1], "Nintendo 64", "Sega Saturn"));

    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[1],
...
static GBL_RESULT GblRingListTestSuite_pushFrontSingle_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushFront(pSelf_->ringLists[1], "GameBoy Color"));
...
static GBL_RESULT GblRingListTestSuite_pushFrontMulti_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushFront(pSelf_->ringLists[1], "Atari Jaguar", "Neo Geo CD"));
...
static GBL_RESULT GblRingListTestSuite_insertSingleFront_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[3], 0, "PS2"));

    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[3],
...
static GBL_RESULT GblRingListTestSuite_insertSingleMiddle_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[1], 2, "Dreamcast"));
...
static GBL_RESULT GblRingListTestSuite_insertMultiBack_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[1], 8, "GameCube", "Wonderswan"));
...
static GBL_RESULT GblRingListTestSuite_insertMultiFrontNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[1], -11, "NES", "Genesis"));
...
static GBL_RESULT GblRingListTestSuite_insertMultiMiddleNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[1], -2, "Super Nintendo", "Switch"));
...
static GBL_RESULT GblRingListTestSuite_insertMultiBackNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insert(pSelf_->ringLists[1], -1, "Colecovision", "Atari 2600"));
...
static GBL_RESULT GblRingListTestSuite_insertSorted_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_insertSorted(pSelf_->ringLists[0],
                                                 "Bad",
                                                 sortComparator_));
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[0],
...
static GBL_RESULT GblRingListTestSuite_joinMiddleNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[3], NULL));
...
static GBL_RESULT GblRingListTestSuite_removeBackMultiNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[1], NULL));
    GBL_API_END();
}
...
static GBL_RESULT GblRingListTestSuite_removeMiddleMultiNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushBack(pSelf_->ringLists[1],
...
static GBL_RESULT GblRingListTestSuite_removeFrontMultiNegative_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[1], "Xbox", "GameCube", NULL));
    GBL_API_END();
}
...
static GBL_RESULT GblRingListTestSuite_clear_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_clear(pSelf_->ringLists[0]));
    GBL_API_VERIFY_CALL(GblRingList_clear(pSelf_->ringLists[1]));
...
static GBL_RESULT GblRingListTestSuite_sort_(GblTestSuite* pSelf, GblContext* pCtx) {
    GBL_API_BEGIN(pCtx);
    GBL_TEST_SKIP("Unimplemented sort");
    GBL_API_END();
}
...
static GBL_RESULT GblRingListTestSuite_rotate_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_pushBack(pSelf_->ringLists[0],
...
static GBL_RESULT GblRingListTestSuite_find_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingListTestSuite_verify_(pCtx, pSelf_->ringLists[0], "GameCube", "Xbox", "Playstation 2", "Dreamcast", NULL));
    GBL_API_END();
}
...
static GBL_RESULT GblRingListTestSuite_destroyShallow_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    for(GblSize l = 0; l < 4; ++l)
        GBL_API_VERIFY_CALL(GblRingList_destroy(pSelf_->ringLists[l]));
...
static GBL_RESULT GblRingListTestSuite_destroyDeep_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_API_VERIFY_CALL(GblRingList_destroy(pSelf_->ringLists[4], listDtor_));
