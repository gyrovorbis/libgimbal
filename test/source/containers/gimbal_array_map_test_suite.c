...
static GBL_RESULT GblArrayMapTestSuite_null_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_CTX_VERIFY_CALL(GblArrayMap_destroy(&pSelf_->pMap1), GBL_RESULT_SUCCESS);
...
static GBL_RESULT GblArrayMapTestSuite_setUserdata_(GblTestSuite* pSelf, GblContext* pCtx) {
    GBL_CTX_BEGIN(pCtx);
    GblArrayMapTestSuite_* pSelf_ = GBL_ARRAY_MAP_TEST_SUITE_(pSelf);
    GBL_CTX_VERIFY_CALL(GblArrayMap_setUserdata(&pSelf_->pMap1,
                                                (uintptr_t)"key1",
                                                (uintptr_t)1,
...
static GBL_RESULT GblArrayMapTestSuite_setUserdata_lazy_(GblTestSuite* pSelf, GblContext* pCtx) {
    GBL_CTX_BEGIN(pCtx);
    GblArrayMapTestSuite_* pSelf_ = GBL_ARRAY_MAP_TEST_SUITE_(pSelf);
    GBL_CTX_VERIFY_CALL(GblArrayMap_setUserdata(&pSelf_->pMap2,
...
static GBL_RESULT GblArrayMapTestSuite_insertUserdata_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_CTX_VERIFY_CALL(GblArrayMapTestSuite_validate_userdata_(pSelf,
                                                                pCtx,
                                                                pSelf_->pMap1,
                                                                (uintptr_t)"key3",
                                                                3));
...
static GBL_RESULT GblArrayMapTestSuite_setVariant_overUserdata_(GblTestSuite* pSelf, GblContext* pCtx) {
    ...
    GBL_CTX_VERIFY_CALL(GblArrayMap_setVariant(&pSelf_->pMap1, (uintptr_t)"key3", &variant));
    GBL_TEST_COMPARE(dtorCalls_, 1);
    GBL_TEST_COMPARE(GblArrayMap_size(&pSelf_->pMap1), 2);
    GBL_CTX_VERIFY_CALL(GblArrayMapTestSuite_validate_variant_(pSelf,
                                                               pCtx,
                                                               pSelf_->pMap1,
                                                               (uintptr_t)"key3",
                                                               4));
...
static GBL_RESULT GblArrayMapTestSuite_extractValue_(GblTestSuite* pSelf, GblContext* pCtx) {
    GBL_CTX_BEGIN(pCtx);
    GblArrayMapTestSuite_* pSelf_ = GBL_ARRAY_MAP_TEST_SUITE_(pSelf);
    GBL_CTX_VERIFY_CALL(GblArrayMap_setUserdata(&pSelf_->pMap1, (uintptr_t)"key7", 7, GblArrayMap_destructor_));
    GBL_TEST_COMPARE(GblArrayMap_size(&pSelf_->pMap1), 3);
    GBL_CTX_VERIFY_CALL(GblArrayMapTestSuite_validate_userdata_(pSelf,
                                                                pCtx,
                                                                pSelf_->pMap1,
                                                                ...
                                                                7));
    uintptr_t value = 0;
    GBL_CTX_VERIFY_CALL(GblArrayMap_extractValue(&pSelf_->pMap1, (uintptr_t)"key7", &value));
...
static GBL_RESULT GblArrayMapTestSuite_destroy_(GblTestSuite* pSelf, GblContext* pCtx) {
    GBL_CTX_BEGIN(pCtx);
    GblArrayMapTestSuite_* pSelf_ = GBL_ARRAY_MAP_TEST_SUITE_(pSelf);
    GBL_CTX_VERIFY_CALL(GblArrayMap_destroy(&pSelf_->pMap1));
    GBL_CTX_VERIFY_CALL(GblArrayMap_destroy(&pSelf_->pMap2));
    GBL_CTX_END();
}
