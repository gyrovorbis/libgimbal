...
#define GBL_THREAD_TEST_SUITE_TYPE             (GBL_TYPEOF(GblThreadTestSuite))

#define GBL_THREAD_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_THREAD_TEST_SUITE_TYPE, GblThreadTestSuite))
#define GBL_THREAD_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST(klass, GBL_THREAD_TEST_SUITE_TYPE, GblThreadTestSuiteClass))
#define GBL_THREAD_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_THREAD_TEST_SUITE_TYPE, GblThreadTestSuiteClass))
