...
#define GBL_RING_BUFFER_TEST_SUITE(inst)          (GBL_CAST(GblRingBufferTestSuite, inst))
#define GBL_RING_BUFFER_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblRingBufferTestSuite, klass))
#define GBL_RING_BUFFER_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblRingBufferTestSuite, inst))
