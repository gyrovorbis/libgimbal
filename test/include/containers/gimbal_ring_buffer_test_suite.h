...
#define GBL_RING_BUFFER_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_RING_BUFFER_TEST_SUITE_TYPE, GblRingBufferTestSuite))
...
#define GBL_RING_BUFFER_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_RING_BUFFER_TEST_SUITE_TYPE, GblRingBufferTestSuiteClass))
