...
#define GBL_ARRAY_DEQUE_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_ARRAY_DEQUE_TEST_SUITE_TYPE, GblArrayDequeTestSuite))
...
#define GBL_ARRAY_DEQUE_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_ARRAY_DEQUE_TEST_SUITE_TYPE, GblArrayDequeTestSuiteClass))
