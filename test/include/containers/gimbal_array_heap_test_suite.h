...
#define GBL_ARRAY_HEAP_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_ARRAY_HEAP_TEST_SUITE_TYPE, GblArrayHeapTestSuite))
...
#define GBL_ARRAY_HEAP_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_ARRAY_HEAP_TEST_SUITE_TYPE, GblArrayHeapTestSuiteClass))
