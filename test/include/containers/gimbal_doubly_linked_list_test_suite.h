...
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE(inst)          (GBL_CAST(GblDoublyLinkedListTestSuite, inst))
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblDoublyLinkedListTestSuite, klass))
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblDoublyLinkedListTestSuite, inst))
