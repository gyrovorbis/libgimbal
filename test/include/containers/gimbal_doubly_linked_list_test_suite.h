...
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE(inst)            (GBL_INSTANCE_CAST_PREFIX(inst, GBL_DOUBLY_LINKED_LIST_TEST_SUITE))
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST_PREFIX(klass, GBL_DOUBLY_LINKED_LIST_TEST_SUITE))
#define GBL_DOUBLY_LINKED_LIST_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST_PREFIX(inst, GBL_DOUBLY_LINKED_LIST_TEST_SUITE))
