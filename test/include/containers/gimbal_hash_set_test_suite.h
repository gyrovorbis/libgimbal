...
#define GBL_HASH_SET_TEST_SUITE(inst)          (GBL_CAST(GblHashSetTestSuite, inst))
#define GBL_HASH_SET_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblHashSetTestSuite, klass))
#define GBL_HASH_SET_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblHashSetTestSuite, inst))
