...
#define GBL_OPAQUE_TEST_SUITE(inst)          (GBL_CAST(GblOpaqueTestSuite, inst))
#define GBL_OPAQUE_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblOpaqueTestSuite, klass))
#define GBL_OPAQUE_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblOpaqueTestSuite, inst))
