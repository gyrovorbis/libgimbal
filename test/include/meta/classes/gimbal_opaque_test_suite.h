...
#define GBL_OPAQUE_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_OPAQUE_TEST_SUITE_TYPE, GblOpaqueTestSuite))
#define GBL_OPAQUE_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST(klass, GBL_OPAQUE_TEST_SUITE_TYPE, GblOpaqueTestSuiteClass))
#define GBL_OPAQUE_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_OPAQUE_TEST_SUITE_TYPE, GblOpaqueTestSuiteClass))
