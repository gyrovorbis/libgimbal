...
#define GBL_POINTER_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_POINTER_TEST_SUITE_TYPE, GblPointerTestSuite))
#define GBL_POINTER_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST(klass, GBL_POINTER_TEST_SUITE_TYPE, GblPointerTestSuiteClass))
#define GBL_POINTER_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_POINTER_TEST_SUITE_TYPE, GblPointerTestSuiteClass))
