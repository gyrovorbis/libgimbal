...
#define GBL_TYPE_TEST_SUITE(inst)          (GBL_CAST(GblTypeTestSuite, inst))
#define GBL_TYPE_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblTypeTestSuite, klass))
#define GBL_TYPE_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblTypeTestSuite, inst))
