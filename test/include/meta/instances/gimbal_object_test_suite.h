...
#define GBL_OBJECT_TEST_SUITE(inst)          (GBL_CAST(GblObjectTestSuite, inst))
#define GBL_OBJECT_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblObjectTestSuite, klass))
#define GBL_OBJECT_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblObjectTestSuite, inst))
