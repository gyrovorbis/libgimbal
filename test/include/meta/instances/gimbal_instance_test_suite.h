...
#define GBL_INSTANCE_TEST_SUITE(inst)          (GBL_CAST(GblInstanceTestSuite, inst))
#define GBL_INSTANCE_TEST_SUITE_CLASS(klass)   (GBL_CAST(GblInstanceTestSuite, klass))
#define GBL_INSTANCE_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblInstanceTestSuite, inst))
