...
#define GBL_INSTANCE_TEST_SUITE(inst)            (GBL_CAST_PREFIX(inst, GBL_INSTANCE_TEST_SUITE))
#define GBL_INSTANCE_TEST_SUITE_CLASS(klass)     (GBL_CAST_PREFIX(klass, GBL_INSTANCE_TEST_SUITE))
#define GBL_INSTANCE_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_GET_CLASS_CAST_PREFIX(inst, GBL_INSTANCE_TEST_SUITE))
