...
#define GBL_BIT_VIEW_TEST_SUITE_TYPE             (GBL_TYPEOF(GblBitViewTestSuite))

#define GBL_BIT_VIEW_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_BIT_VIEW_TEST_SUITE_TYPE, GblBitViewTestSuite))
#define GBL_BIT_VIEW_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST(klass, GBL_BIT_VIEW_TEST_SUITE_TYPE, GblBitViewTestSuiteClass))
#define GBL_BIT_VIEW_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_BIT_VIEW_TEST_SUITE_TYPE, GblBitViewTestSuiteClass))
