...
#define GBL_SCANNER_TEST_SUITE_TYPE             (GBL_TYPEOF(GblScannerTestSuite))

#define GBL_SCANNER_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_SCANNER_TEST_SUITE_TYPE, GblScannerTestSuite))
#define GBL_SCANNER_TEST_SUITE_CLASS(klass)     (GBL_CLASS_CAST(klass, GBL_SCANNER_TEST_SUITE_TYPE, GblScannerTestSuiteClass))
#define GBL_SCANNER_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_SCANNER_TEST_SUITE_TYPE, GblScannerTestSuiteClass))
