...
#define GBL_OPTION_GROUP_TEST_SUITE_TYPE             (GBL_TYPEOF(GblOptionGroupTestSuite))

#define GBL_OPTION_GROUP_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_OPTION_GROUP_TEST_SUITE_TYPE, GblOptionGroupTestSuite))
...
#define GBL_OPTION_GROUP_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_OPTION_GROUP_TEST_SUITE_TYPE, GblOptionGroupTestSuiteClass))
