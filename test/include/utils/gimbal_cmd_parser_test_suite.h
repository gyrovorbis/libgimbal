...
#define GBL_CMD_PARSER_TEST_SUITE_TYPE             (GBL_TYPEOF(GblCmdParserTestSuite))

#define GBL_CMD_PARSER_TEST_SUITE(inst)            (GBL_INSTANCE_CAST(inst, GBL_CMD_PARSER_TEST_SUITE_TYPE, GblCmdParserTestSuite))
...
#define GBL_CMD_PARSER_TEST_SUITE_GET_CLASS(inst)  (GBL_INSTANCE_CLASS_CAST(inst, GBL_CMD_PARSER_TEST_SUITE_TYPE, GblCmdParserTestSuiteClass))
