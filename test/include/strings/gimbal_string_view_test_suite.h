...
#define GBL_STRING_VIEW_TEST_SUITE(inst)          (GBL_CAST(GblStringViewTestSuite, inst))
#define GBL_STRING_VIEW_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblStringViewTestSuite, klass))
#define GBL_STRING_VIEW_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblStringViewTestSuite, inst))
