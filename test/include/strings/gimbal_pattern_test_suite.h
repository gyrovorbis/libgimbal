...
#define GBL_PATTERN_TEST_SUITE(inst)          (GBL_CAST(GblPatternTestSuite, inst))
#define GBL_PATTERN_TEST_SUITE_CLASS(klass)   (GBL_CLASS_CAST(GblPatternTestSuite, klass))
#define GBL_PATTERN_TEST_SUITE_CLASSOF(inst)  (GBL_CLASSOF(GblPatternTestSuite, inst))
